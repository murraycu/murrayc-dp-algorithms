...
test_type() {
  ...
  static_assert(is_same0, "unexpected type");

  using type_vec1 = murraycdp::utils::vector_of_vectors<int, 1>::type;
  constexpr auto is_same1 = std::is_same<type_vec1, std::vector<int>>::value;
  static_assert(is_same1, "unexpected type");

  using type_vec2 = murraycdp::utils::vector_of_vectors<int, 2>::type;
  constexpr auto is_same2 =
    std::is_same<type_vec2, std::vector<std::vector<int>>>::value;
  static_assert(is_same2, "unexpected type");

  using type_vec3 = murraycdp::utils::vector_of_vectors<int, 3>::type;
  constexpr auto is_same3 =
    std::is_same<type_vec3, std::vector<std::vector<std::vector<int>>>>::value;
  static_assert(is_same3, "unexpected type");
}
...
test_get_at() {
  ...
  const auto val3 =
    murraycdp::utils::get_at_vector_of_vectors<int>(vec3, 3, 4, 5);
  assert(val3 == 9);
}
...
test_get_at_const() {
  ...
  const auto val1 =
    murraycdp::utils::get_at_vector_of_vectors<int>(vec1_const, 3);
  assert(val1 == 9);
  ...
  const auto val2 =
    murraycdp::utils::get_at_vector_of_vectors<int>(vec2_const, 3, 4);
  assert(val2 == 9);
  ...
  const auto val3 =
    murraycdp::utils::get_at_vector_of_vectors<int>(vec3_const, 3, 4, 5);
  assert(val3 == 9);
}
...
test_for0() {
  ...
  std::size_t n = 0;
  murraycdp::utils::for_vector_of_vectors(vec0, [&n](int i) { n += i; });
...
test_for1() {
  ...
  std::size_t n = 0;
  murraycdp::utils::for_vector_of_vectors(
    vec1, [&n](int i) { n += i; }, (std::size_t)0, (std::size_t)10);
  // std::cout << "n=" << n << std::endl;
  assert(n == 45);
}
...
test_for2() {
  ...
  murraycdp::utils::for_vector_of_vectors(vec2,
    [&n](int i, int j) { n += (i + j); }, (std::size_t)0, (std::size_t)10,
...
test_for3() {
  ...
  murraycdp::utils::for_vector_of_vectors(vec3,
    [&n](int i, int j, int k) { n += (i + j + k); }, (std::size_t)0,
    (std::size_t)10, (std::size_t)0, (std::size_t)20, (std::size_t)0,
    (std::size_t)30);
  // std::cout << "n=" << n << std::endl;
  assert(n == 171000);
}
