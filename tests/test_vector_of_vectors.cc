...
void test_type() {
  ...
  using type_vec0 = murraycdp::vector_of_vectors<int, 0>::type;
  const auto is_same0 = std::is_same< type_vec0,
    std::vector<int> >::value;
  assert(is_same0);

  using type_vec1 = murraycdp::vector_of_vectors<int, 1>::type;
  const auto is_same1 = std::is_same<type_vec1,
    std::vector<std::vector<int>> >::value;
  assert(is_same1);

  using type_vec2= murraycdp::vector_of_vectors<int, 2>::type;
...
void test_resize() {
  using type_vec0 = murraycdp::vector_of_vectors<int, 0>::type;
  type_vec0 vec0;
  murraycdp::resize_vector_of_vectors(vec0, 10);
  assert(vec0.size() == 10);

  using type_vec1 = murraycdp::vector_of_vectors<int, 1>::type;
  type_vec1 vec1;
  murraycdp::resize_vector_of_vectors(vec1, 10, 20);
  assert(vec1.size() == 10);
  assert(vec1[0].size() == 20);

  using type_vec2 = murraycdp::vector_of_vectors<int, 2>::type;
  type_vec2 vec2;
  murraycdp::resize_vector_of_vectors(vec2, 10, 20, 30);
  assert(vec2.size() == 10);
...
void test_for0() {
  ...
  std::size_t n = 0;
  murraycdp::for_vector_of_vectors(vec0,
    [&n] (int i) {
      n += i;
    },
...
void test_for1() {
  ...
  std::size_t n = 0;
  murraycdp::for_vector_of_vectors(vec1,
    [&n] (int i, int j) {
      n += (i + j);
    },
    (std::size_t)0, (std::size_t)10,
...
void test_for2() {
  ...
  std::size_t n = 0;
  murraycdp::for_vector_of_vectors(vec2,
    [&n] (int i, int j, int k) {
      n += (i + j + k);
    },
    (std::size_t)0, (std::size_t)10,
